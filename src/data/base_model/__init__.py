...
class BaseAgent(BaseModel):
    ...
    image_recognizer_id: str | None = Field(default=None, description="Image recognizer configuration ID", min_length=1)
    retriever_ids: list[str] | None = Field(default=None, description="Retriever configuration IDs", min_length=1)
    tool_ids: list[str] | None = Field(description="Tool configuration IDs", default=None, min_length=1)
